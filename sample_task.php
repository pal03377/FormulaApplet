...
<p class="formula_applet" id="no_res">\int_{3}^{ x} t^2 dt = \frac{x^3}{3} - 9   + \int_2^5\sin x\ dx</p> Integral.<br />
<p class="formula_applet" id="no_res">sin^2 \alpha + cos^2\alpha = 1</p> No result field {{...}} necessary.<br />
